 ...
 */
public class GetCilentWorkspacesTest {
    /**
     *  GetCilentWorkspacesTest：查询所有报修单客户工作单位
     */
    @BeforeClass
    ...
    public void test01(){
        ...
        assertTrue(createRepairForms(20,0,"zhaiwei","186102","Beijing University","Beijing University",10000,99997,99996,date));
        assertTrue(createRepairForms(20,0,"wanglin","186103","Tianjing University","Tianjing University",10000,99997,99996,date));

        String url = "http://"+host+"/repairforms/clientWorkspaces";
        String returnInformation = HttpRequest.sendGet(url,"");

        assertTrue(returnInformation.contains("Nanjing University"));
        assertTrue(returnInformation.contains("Beijing University"));
        assertTrue(returnInformation.contains("Tianjing University"));
